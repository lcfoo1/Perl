...
use ASP qw(:strict);
my $StatusFlag = 0;
my $SummaryWorkstation = 'C:\winnt\WSMon\SummaryWS.txt';
	...
	else
	{
		...
		elsif (/Team=(.*)/)
		{
			...
			elsif ($Team =~ /TM/i)
			{
				$Response->Write("<TD BGCOLOR=#CC99FF><B><FONT SIZE=2>$Team</FONT></B></TD>\n");
				#$Response->Write("<TD BGCOLOR=#C9FC9F><B><FONT SIZE=2>$Team</FONT></B></TD>\n");
				#$Response->Write("<TD BGCOLOR=#FFFF99><B><FONT SIZE=2>$Team</FONT></B></TD>\n");
			}
			elsif ($Team =~ /PS/i)
			{
				$Response->Write("<TD BGCOLOR=#FFFFC3><B><FONT SIZE=2>$Team</FONT></B></TD>\n");
			...
			$Response->Write("<TD BGCOLOR=red><B><FONT SIZE=2>No User</FONT></B></TD>\n");
