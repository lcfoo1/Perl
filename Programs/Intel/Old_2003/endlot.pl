...
#	02/16/2004								#
#										#
#	End_Lot.pl is to integrate with the end lot function on the OIF		#
...
#										#
#	Require Perl 5.0, ftpToSOD.pl						#
#										#
#	Rev 1.0									#
#										#
#################################################################################

#require '/lopte/home1/lfoo1/DataBroker/ftpToSOD.pl';

### Main program starts here ###
# Format: wafer.pl <lot#>

$Lot = $ARGV[0];
$OrgDir = "/lopte/data/summary/t3/".$Lot."_8012/";
	...
	foreach $File (@Files)
	{
		...
		while (<FILE>)
		{
			if (/4_wafid_(\w+)/)
			{
				...
				$AriesDir = "/lopte/intel/hp94k/sort/aries/data/ituff/".$Lot."_8012/";
				if ($count == 0)
				{
					qx/mkdir $AriesDir/;
					$count = 1;
...
{
	$WaferID = shift;	
	$AriesSigFile = "/lopte/intel/hp94k/sort/aries/signal/ituff/".$Lot."_8012_".$WaferID.".sig";
...
sub DataBrokerSig
{
	...
	$DataBrokerSigFile = "/lopte/intel/hp94k/sort/databroker/signal/SORT==DATALOGS==".$Lot."_8012==W".$WaferID.".sig";
