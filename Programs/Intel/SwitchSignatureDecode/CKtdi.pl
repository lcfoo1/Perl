#!/usr/intel/bin/perl
my $Dir = '/nfs/png/disks/wmtpe282/lfoo1/work/cktm/M3/preamble';
my $ODir = '/nfs/png/disks/wmtpe282/lfoo1/work/cktm/M3/output';
my $CDir = '/nfs/png/disks/wmtpe282/lfoo1/work/cktm/M3/chk';
